...
import { SidebarOpenButton } from "@/components/SidebarOpenControl";
  ...
  return (
    <div className={`tool-page-header${isAiSearch ? " tool-page-header--landing" : ""}`} data-tool-tag={tool.tag}>
      <div className="tool-page-header-actions">
        {showSidebarOpen ? <SidebarOpenButton variant="inline" /> : null}
        {chatCtx ? (
          <button
            type="button"
