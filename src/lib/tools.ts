...
export const tools: Tool[] = [
  ...
  },
  {
    id: "video-extract",
    title: "视频链接提取",
    description: "抖音、B 站、YouTube、X、微信视频号、Telegram、Instagram 等；多清晰度与本页直接下载。",
    href: "/tools/video-extract",
    gradient: "from-cyan-500/20 to-blue-500/10",
    tag: "视频",
    bento: "default",
    demoHint: "主流社媒 / 视频号链接 → 解析下载",
  },
  {
    id: "image-studio",
    title: "图像工坊",
    description: "压缩、变清晰、抠图本地处理；火山方舟 Seedream 文生图。",
  ...
  },
  {
    id: "memory",
    title: "记忆库",
    description: "登录后保存个人偏好与重要信息，AI 对话会自动参考你的专属记忆。",
    href: "/tools/memory",
    gradient: "from-emerald-500/20 to-teal-500/10",
    tag: "AI",
    bento: "default",
    demoHint: "保存偏好 · AI 越聊越懂你",
  },
  {
    id: "ai-search",
    title: "AI 全网搜索",
