#!/usr/bin/env python3
"""从本机浏览器导出 bilibili.com Cookie 到 cookies/bilibili.txt"""
...
OUT = os.path.join(ROOT, "cookies", "bilibili.txt")
DOMAINS = (".bilibili.com", "bilibili.com", "www.bilibili.com", ".b23.tv", "b23.tv")
SITE_KEY = "bilibili"
LOGIN_URL = "https://www.bilibili.com/"


def preferred_browsers():
    env_browser = os.environ.get("BILIBILI_BROWSER") or os.environ.get(
...
def export_from_browser(browser_cookie3, browser_name):
    ...
    if count == 0:
        try:
            for c in get_fn():
                if c.domain and SITE_KEY in c.domain:
                    add_cookie(c)
...
def main():
    ...
    print("未找到 bilibili.com 的 Cookie。", file=sys.stderr)
    print(
        "请在 Safari 打开 https://www.bilibili.com 并登录；"
