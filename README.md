...
| [分镜生图](/tools/storyboard) | 输入视频主题或脚本，AI 自动拆分分镜并为每个镜头生成配图 | 填写主题 → 选镜头数与比例 → 生成分镜图片 → 下载或复制脚本 |
...
| [网页视频提取](/tools/web-video-extract) | 粘贴网页链接，自动扫描页面中的视频并下载 | 粘贴网页地址 → 扫描网页 → 选择视频下载 |
...
| 你想用的功能 | 需要准备什么 |
|--------------|--------------|
| AI 写作、分镜规划、全网搜索 | [DeepSeek](https://platform.deepseek.com/api_keys) API Key（国内可直接用） |
| AI 全网搜索 | 另需 [Tavily](https://tavily.com) 或 [Serper](https://serper.dev) 搜索 Key（二选一，推荐 Tavily） |
| 图像工坊 · AI 生图 / 分镜生图出图 / 人像美化、云端转写 | [火山方舟](https://console.volcengine.com/ark) API Key |
| 我的素材库 | 访问密码（由站点管理员设置） |
